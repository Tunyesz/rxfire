...
import type { UploadTaskSnapshot, StorageReference, UploadMetadata, StringFormat, UploadTask, UploadResult, FullMetadata } from 'firebase/storage';
...
export declare function getMetadata(ref: StorageReference): Observable<FullMetadata>;
